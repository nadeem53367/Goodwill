    ...
    <nav>
        <div class="rn_NavigationBar">
            ...
            <ul class="rn_NavigationMenu">
                 ...
                 <!-- <li><rn:widget path="navigation/NavigationTab" label_tab="Supply Chain" link="/cc/GWController/createSession?Department=3&Category=4" /></li> --> <? } ?>
        ...
        <div class="rn_LoginStatus">
            ...
            <rn:condition_else/>
                <rn:condition is_social_moderator="true">
                    <rn:widget path="login/AccountDropdown" subpages="#rn:msg:SUPPORT_HISTORY_LBL# > account/questions/list>, #rn:msg:MODERATION_LBL# > social/moderate/overview"/> <!-- #rn:msg:ACCOUNT_OVERVIEW_LBL# > account/overview, -->
                <rn:condition_else/>
                    <rn:condition is_active_social_user="true">
                        <rn:widget path="login/AccountDropdown" subpages="#rn:msg:SUPPORT_HISTORY_LBL# > account/questions/list"/> <!-- #rn:msg:ACCOUNT_OVERVIEW_LBL# > account/overview, -->
                    <rn:condition_else/>
                        <rn:widget path="login/AccountDropdown" subpages=" #rn:msg:SUPPORT_HISTORY_LBL# > account/questions/list"/><!-- #rn:msg:ACCOUNT_OVERVIEW_LBL# > account/overview, -->
                    </rn:condition>
                </rn:condition>
