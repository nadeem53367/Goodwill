...
//echo "<pre>"; print_r($contact->ContactType->LookupName); echo "</pre>";
?>
<div class="rn_Hero">
...
<div class="rn_PageContent rn_AccountOverview rn_Container">
    <div class="rn_ContentDetail">
        ...
        <? if ($ContactType == 'Technician - Facilities')  
        {   ?> 
         <div class="rn_Discussions">
            <h2>Assigned Work Orders</h2>
            <rn:widget path="reports/Grid" report_id="100017"  static_filter='Technician=#rn:profile:contactID# ' /> 
        </div> 
        <? } ?>
    </div> 
